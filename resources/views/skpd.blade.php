...
<div id="boxDet">
			<center>
		      ...
		      <div class="caption"><br>
		        <h4>Surat Keterangan Perbedaan Data</h4><br>
		      <br>
		      <div class="alert alert-info"><h5>Silahkan isi data di bawah ini</h5></div>
		      </center>
					    <form action="{{ route('plynCtrl@prosPD') }}" method="post">
					        <div class="form-group">
					          <label for="NIK">NIK</label>
					          <input type="number" class="form-control" name="nik">
					        </div>
					        <div class="form-group">
					          <label for="perbD">Perbedaan Data</label>
					          <textarea class="form-control" name="perbD">Jika perbedaan lebih dari 1 pisahkan dengan | </textarea>
					        </div>
					        <div class="form-group">
